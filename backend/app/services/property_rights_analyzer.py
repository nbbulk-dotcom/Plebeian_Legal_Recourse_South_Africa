...
class PropertyRightsAnalyzer:
    ...
    async def analyze_comprehensive_case(self, case_details: Dict[str, Any]) -> Dict[str, Any]:
        analysis = {
            ...
            "constitutional_challenges": await self._analyze_constitutional_issues(case_details),
            "success_probability": await self._calculate_success_probability(case_details),
    ...
    async def _generate_case_summary(self, case_details: Dict[str, Any]) -> Dict[str, Any]:
        return {
    ...
    async def _analyze_criminal_charges(self, case_details: Dict[str, Any]) -> List[Dict[str, Any]]:
        charges = [
            {
                ...
                "evidence_required": ["Bank statements", "Communication records", "Witness statements"],
            ...
            },
            {
                ...
                "evidence_required": ["Utility bills", "Meter readings", "Municipal records"],
            ...
            },
            {
                ...
                "evidence_required": ["Communication records", "Witness statements", "Payment records"],
                "filing_location": "Local SAPS station",
            ...
            },
            {
                ...
                "evidence_required": ["False documents", "Communication records", "Financial records"],
                "filing_location": "Local SAPS station",
                "estimated_sentence": "Imprisonment up to 15 years"
            }
        ]
    ...
    async def _analyze_civil_remedies(self, case_details: Dict[str, Any]) -> List[Dict[str, Any]]:
        remedies = [
            {
                ...
                "requirements": ["Notice to occupiers", "Municipal consultation", "Alternative accommodation consideration"]
            },
            {
    ...
    async def _analyze_constitutional_issues(self, case_details: Dict[str, Any]) -> List[Dict[str, Any]]:
        issues = [
            {
                ...
                "precedent_cases": ["FNB v Minister of Finance 2002", "Jaftha v Schoeman 2005"],
            ...
            },
            {
                ...
                "precedent_cases": ["Bato Star Fishing v Minister of Environmental Affairs 2004"],
    ...
    async def _calculate_success_probability(self, case_details: Dict[str, Any]) -> Dict[str, float]:
        return {
    ...
    async def _generate_document_package(self, case_details: Dict[str, Any]) -> Dict[str, List[str]]:
        return {
            "criminal_documents": [
